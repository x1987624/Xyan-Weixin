...
namespace Weixin.Controllers
{
    ...
    {
        private readonly IBaseUserService _userInfoService;

        private readonly IBaseRoleService _roleInfoService;

        public UserInfoController(IBaseUserService userInfoService, IBaseRoleService roleInfoService)
        {
